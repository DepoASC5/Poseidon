...
function bitcoinInfo () {
    window.location.href = 'bitcoinData.html';
}

function litecoinInfo () {
    window.location.href = 'litecoinData.html';
}

function ethereumInfo () {
    window.location.href = 'ethereumData.html';
}

function bitcoinCashInfo () {
    window.location.href = 'bitcoinCashData.html';
}
